...
function Player(props) {
    ...
    let playerPosition = props.actualPlayerPosition ? props.actualPlayerPosition : '0 1 0';
    ...
    return (
        <a-entity id="player" look-controls>
            ...
            <a-camera id="control" primitive="a-camera" position={playerPosition}>
                {defaultSettings.cursorVisibility && <a-cursor fuse="true" fuseTimeout="300" scale="0.5 0.5 0.5" position="0 0 -1" material="color: white"/>}
